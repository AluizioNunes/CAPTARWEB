# Script completo: Subir containers e copiar banco de dados
# 1. Subir containers (com PostgreSQL 18 na porta 5435)
...
Write-Host "Aguardando inicializacao (40 segundos)..." -ForegroundColor Yellow
...
Write-Host "  ✓ PostgreSQL 18 na porta 5435" -ForegroundColor Green
Write-Host "  ✓ Banco de dados copiado" -ForegroundColor Green
Write-Host "  ✓ Todos os dados preservados" -ForegroundColor Green
Write-Host ""
